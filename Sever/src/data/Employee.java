...
//多的一个构造函数
    public Employee(String name, String sex, String posts, String phoneNumber, int salary) {
        this.name = name;
        this.sex = sex;
        this.posts = posts;
        this.phoneNumber = Integer.valueOf(phoneNumber);
...
//    }
//
//    public Employee(Integer ID,String name, String sex, String posts, String phoneNumber,Integer salary) {
//        this.name = name;
//        this.sex = sex;
//        this.posts = posts;
//        this.phoneNumber = Integer.valueOf(phoneNumber);
...
//     * @param salary 薪水
//     */
//    public Employee(String name, String sex, String posts, String phoneNumber, String salary) {
//        this.name = name;
//        this.sex = sex;
//        this.posts = posts;
//        this.phoneNumber = Integer.valueOf(phoneNumber);
